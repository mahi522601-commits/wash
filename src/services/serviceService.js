...
export const DEFAULT_SERVICES = [
  ...
  },
  {
    ...
    emoji: '🪟',
    icon: '🪟',
    shortDescription: 'Comprehensive curtain care: Dry Cleaning, Wash & Iron, Steam Ironing, and Wash & Fold.',
    detailedDescription: 'Curtains trap dust mites, allergens, and airborne pollutants. We provide 4 specialized care treatments: Dry Cleaning, Wash & Iron, Steam Ironing, and Wash & Fold to restore fresh air and vibrancy to all blackout drapes, sheers, and heavy jacquard curtains.',
    ...
    features: [
      'Dry Cleaning for delicate, silk & blackout drapes',
      'Wash & Iron with vertical steam hanging press',
      'Steam Ironing only for crisp wrinkle release',
      'Hygienic Wash & Fold laundry cycle'
    ],
    subServices: [
      { id: 'curtain-dc', name: 'Dry Cleaning', price: 200, emoji: '🧺' },
      { id: 'curtain-wi', name: 'Wash & Iron', price: 150, emoji: '🫧' },
      { id: 'curtain-ir', name: 'Iron', price: 60, emoji: '✨' },
      { id: 'curtain-wf', name: 'Wash & Fold', price: 100, emoji: '👕' },
    ],
    benefits: [

...
export const DEFAULT_OFFERS = [
  {
    ...
    featured: true,
    priority: 1,
    associatedServiceSlug: 'dry-cleaning',
    active: true,
    showInPopup: true,
  },
  {
    ...
    discountNum: 99,
    shortDescription: 'Priority laboratory turnaround on all laundry & dry cleaning orders above ₹999.',
    minOrder: '₹999',
    maxDiscount: '₹99',
    validTill: 'Limited Period',
    featured: false,
    priority: 2,
    associatedServiceSlug: 'laundry',
    active: true,
    showInPopup: false,
  },
  {
    id: 'off-3',
    code: 'STAINFREE',
    title: 'Stain Removal Special Offer',
    badgeText: '👑 EXCLUSIVE',
    discountType: 'percentage',
    discountValue: '15% OFF',
    discountNum: 15,
    shortDescription: 'Ultrasonic bio-enzyme precision stain removal for fine garments.',
    minOrder: '₹499',
    maxDiscount: '₹200',
    validTill: 'Special Offer',
    featured: false,
    priority: 3,
    associatedServiceSlug: 'stains-remover',
    active: true,
    showInPopup: false,
  },
];

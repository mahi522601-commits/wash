...
export const InteractiveBookingStepper = ({
  ...
  if (confirmedOrder) {
    return (
      <div className="p-4 rounded-2xl bg-[#F5F3FF] border-2 border-[#6D28D9]/40 text-center space-y-3 animate-fade-in text-xs">
        ...
        <div>
          ...
          <h4 className="text-sm font-black text-[#1E1B4B] mt-1">
        ...
        <div className="p-3 rounded-xl bg-white border border-brand-200 text-left space-y-1 text-[11px]">
          ...
          <div className="flex justify-between">
            ...
            <span className="font-bold text-[#6D28D9]">{formatCurrency(confirmedOrder.totalAmount)}</span>
          </div>
        ...
        <a
          ...
          className="block py-2 px-4 rounded-xl bg-[#6D28D9] hover:bg-[#5B21B6] text-white font-bold text-xs transition-colors shadow-sm"
        >
    ...
    <div className="p-4 rounded-2xl bg-white border border-brand-200 shadow-sm space-y-3.5 animate-fade-in text-xs">
            ...
            {[
              ...
              <button
                ...
                className={`p-2.5 rounded-xl border text-left font-bold text-[11px] transition-all flex items-center justify-between ${
                  selectedService === srv
                    ? 'bg-[#F5F3FF] border-[#6D28D9] text-[#6D28D9] shadow-sm'
                    : 'bg-slate-50 border-slate-200 text-slate-700 hover:bg-slate-100'
                }`}
              >
                <span>{srv}</span>
                {selectedService === srv && <Check className="w-3 h-3 text-[#6D28D9]" />}
              </button>
            ))}
          </div>
        </div>
      ...
      {step === 2 && (
        <div className="space-y-2.5">
          ...
          {/* Live Estimate Bar */}
          <div className="p-2 rounded-xl bg-[#F5F3FF] border border-[#6D28D9]/20 flex items-center justify-between text-xs">
            <span className="font-bold text-slate-700">Estimated Total:</span>
            <span className="font-black font-mono text-[#6D28D9]">
                ...
                <button
                  ...
                  className={`p-2 rounded-lg border text-center font-semibold text-[10px] transition-all ${
                    schedule.pickupSlot === slot
                      ? 'bg-brand-50 border-[#6D28D9] text-[#6D28D9] font-bold'
        ...
        <div className="space-y-3">
          <div className="p-2.5 rounded-xl bg-slate-50 border border-slate-200 space-y-1.5 text-[11px]">
            ...
            <div className="flex justify-between pt-1 border-t border-slate-200 font-bold text-xs">
              ...
              <span className="text-[#6D28D9] font-mono">{formatCurrency(estimatedTotal)}</span>
            </div>
          </div>
          ...
          <div className="space-y-2">
            <input
              ...
              className="w-full p-2 rounded-lg bg-white border border-slate-300 text-xs text-slate-900"
            />
            <input
              type="tel"
      ...
      <div className="pt-2 border-t border-slate-100 flex items-center justify-between gap-2">
        ...
        {step < 5 ? (
          <button
            type="button"
            onClick={() => setStep((s) => s + 1)}
            className="px-4 py-1.5 rounded-lg bg-[#6D28D9] hover:bg-[#5B21B6] text-white font-bold text-[11px] flex items-center gap-1 shadow-sm transition-all"
          >
            <span>Continue</span>
          ...
          <button
            ...
            className="px-5 py-2 rounded-xl bg-gradient-to-r from-[#1E1B4B] to-[#6D28D9] text-white font-bold text-xs flex items-center gap-1.5 shadow-md hover:scale-105 active:scale-95 transition-all disabled:opacity-50"
          >

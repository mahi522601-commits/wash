...
export const TermsPage = () => {
  ...
  return (
    <>
      <SEOHead
        title="Terms of Service | Tech Wash Laundry Services"
        description="Terms and conditions for laundry pickup, dry cleaning, and garment care services provided by Tech Wash in Hyderabad."
